                ...
                <div className="relative z-10 px-4 md:px-10 py-10 md:py-16 max-w-6xl mx-auto w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pb-20">
                        {modulesWithProgress.map((module) => (
                            <div
                                key={module.id}
                                className="group relative bg-white dark:bg-surface-dark rounded-[3rem] p-10 shadow-sm border border-gray-100 dark:border-gray-800/50 hover:shadow-3xl hover:shadow-primary/10 hover:-translate-y-3 transition-all duration-700 flex flex-col h-full overflow-hidden"
                            >
                                ...
                                <div className="flex justify-between items-start mb-10 relative z-10">
                                    <div className={`w-20 h-20 rounded-[1.5rem] ${module.imageColor || "bg-primary/10"} flex items-center justify-center text-primary-dark dark:text-primary ring-8 ring-gray-50/50 dark:ring-white/5 shadow-inner transition-transform duration-700 group-hover:scale-110 group-hover:rotate-3`}>
                                        <span className="material-symbols-outlined text-4xl font-light">{module.icon || "school"}</span>
                                    </div>
                                ...
                                <div className="flex-1 relative z-10">
                                    <h3 className="text-3xl font-black mb-4 leading-tight tracking-tight group-hover:text-primary transition-colors duration-500">
                                        {module.title}
                                    </h3>
                                    <p className="text-text-secondary-light dark:text-gray-400 text-base leading-relaxed mb-10 line-clamp-3 font-medium opacity-70 group-hover:opacity-100 transition-opacity duration-500">
                                        {module.description}
                                    </p>

                                    <div className="flex flex-wrap items-center gap-4 text-[11px] font-black tracking-[0.15em] uppercase text-gray-400 dark:text-gray-500 mb-10">
                                        <div className="flex items-center gap-2.5 px-4 py-2 bg-gray-50 dark:bg-gray-800/30 rounded-2xl border border-gray-100 dark:border-gray-800/50">
                                            <span className="material-symbols-outlined text-[20px] text-primary">signal_cellular_alt</span>
                                ...
                                <div className="mt-auto space-y-8 pt-10 border-t border-gray-50 dark:border-gray-800/30 relative z-10">
                                    <div className="space-y-3.5">
                                        <div className="flex justify-between items-end px-1">
                                            <span className="text-[11px] font-black uppercase tracking-[0.2em] text-gray-400">Jouw Voortgang</span>
                                            <span className="text-2xl font-black text-primary tracking-tighter">{module.progress}%</span>
                                        </div>
                                        <div className="h-4 bg-gray-100 dark:bg-gray-800/50 rounded-full overflow-hidden p-1 shadow-inner">
                                            <div
                                            ...
                                            >
                                                ...
                                                {/* Sparkle end-cap */}
                                                <div className="absolute right-0 top-0 bottom-0 w-2 hover:w-4 transition-all bg-white/40 blur-sm"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <Link
                                        ...
                                        className="group/btn relative flex items-center justify-center gap-4 w-full py-5 bg-primary hover:bg-primary-dark text-white rounded-[1.5rem] font-black text-sm tracking-[0.25em] uppercase transition-all duration-500 shadow-2xl shadow-primary/20 hover:shadow-primary/50 active:scale-[0.98] overflow-hidden"
                                    >
                                        ...
                                        <span className="material-symbols-outlined text-2xl transition-all duration-500 group-hover/btn:translate-x-2 relative z-10">arrow_forward_ios</span>
