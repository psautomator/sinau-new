...
const pronunciationPrompt = ai.definePrompt({
    ...
    Also, provide concise, actionable feedback in Dutch to help the user improve. Focus on specific sounds ze verkeerd uitspraken. Als de uitspraak erg goed is, geef ze dan een compliment.
    
    Reference Text: {{{referenceText}}}
    User's Audio Recording: {{media url=audioDataUri}}`,
});

export const evaluatePronunciationFlow = ai.defineFlow(
    {
